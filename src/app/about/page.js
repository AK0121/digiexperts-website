...
import { ChevronRight, Users, Target, Award, Lightbulb, Globe, Zap } from 'lucide-react'
  ...
  const values = [
    {
      icon: Lightbulb,
      title: 'Innovation',
      description: 'We stay ahead of digital trends to deliver cutting-edge solutions that drive your business forward.'
    },
    {
      icon: Users,
      title: 'Client-Centric',
      description: 'Your success is our priority. We build lasting partnerships through transparent communication and exceptional results.'
    },
    {
      icon: Target,
      title: 'Results-Driven',
      description: 'Every strategy we implement is designed to deliver measurable outcomes and maximize your ROI.'
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'From local startups to international brands, we help businesses succeed across all markets.'
    }
  ]
  ...
  const team = [
    {
      name: 'Sarah Johnson',
      role: 'Founder & CEO',
      description: 'Digital strategist with 10+ years of experience in transforming businesses through technology.'
    },
    {
      name: 'Mike Chen',
      role: 'CTO',
      description: 'Full-stack developer and tech architect passionate about building scalable digital solutions.'
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2019, DigiExperts began as a small team of passionate developers and designers 
                who believed that every business deserves exceptional digital solutions. What started as a 
                vision to bridge the gap between technology and business success has grown into a trusted 
              ...
              <motion.button
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-lg hover:shadow-lg transition-all"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {team.map((member, index) => (
              ...
              >
                <div className="w-24 h-24 bg-gradient-to-r from-blue-500 to-green-500 rounded-full mx-auto mb-6"></div>
